...
\subsubsection{Kategorizacija datoteka u foldere}
\begin{tabular}{|
>{\columncolor[HTML]{FFCE93}}c |l|}
\hline
Funkcionalnost        & Kategorizacija datoteka u foldere                                                                                                                                                                                                                             \\ \hline
Opis                  & \begin{tabular}[c]{@{}l@{}}Potrebno je omogućiti da korisnik spašava datoteke \\ u foldere.\end{tabular}                                                                                                                         \\ \hline
Preduslovi            & \begin{tabular}[c]{@{}l@{}}1.Dokument postoji na lokalnom uređaju  \\ 2. Korisnik je prijavljen na sistem\\ \end{tabular}                                                                         \\ \hline
Ulaz                  & \begin{tabular}[c]{@{}l@{}}1. Ime dokumenta\\ 2. Pdf dokument \\ 3. Naziv foldera\end{tabular}                                                                                                                 \\ \hline
Uslovi validnosti     & \begin{tabular}[c]{@{}l@{}}1. Dokument je validan i u odgovarajúcem je formatu (.pdf) \\ \end{tabular}                                                                                                           \\ \hline
Procesiranje   & \begin{tabular}[c]{@{}p{.70\textwidth}@{}}1. Odabir opcije za upload dokumenta.\\ 2. Odabir dokumenta.\\ 3. Unos imena dokumenta.\\ 4. Unos opisa dokumenta (po želji korisnika, u svrhu lakšeg pronalaženja dokumenta)\\ 5. Unos naziva foldera \\6. Potvrda akcije.\end{tabular} \\ \hline
Izlaz     & \begin{tabular}[c]{@{}p{.70\textwidth}@{}} Obavijest o uspješnom prenosu dokumenta ili eventualnoj grešci te otvaranje dokumenta ukoliko je prenos obavljen uspješno.\end{tabular} \\ \hline
Funkcionalni zahtjevi & \begin{tabular}[c]{@{}p{.70\textwidth}@{}}1. Sistem omogućava online pohranu/skladištenje datoteka.\\ 2. Validacija na klijentu (forma za unos dokumenta).\\ 3. Validacija na serveru.\end{tabular} \\ \hline
Prioritet realizacije & \begin{tabular}[c]{@{}p{.70\textwidth}@{}}Ova funkcionalnost nije neophodna za funkcionisanje sistema \\ Priroritet: III \end{tabular}\\ \hline
\end{tabular}